...
export function generateRaceBarChartOption({
  raceData
}: {
  raceData: number[]
} & DynamicBarchartPropsInterface): echarts.EChartsOption {
...
export function generateAnimationBarChartOption({
  animationXData,
  animationData1,
  animationData2
}: {
  animationXData: string[],
  animationData1: number[],
  animationData2: number[],
} & DynamicBarchartPropsInterface): echarts.EChartsOption {
  return {
    title: {
...
export function generateLargeScaleBarChartOption({
}: {
} & DynamicBarchartPropsInterface): echarts.EChartsOption {
...
export function generateFinanceBarChartOption({
}: {
} & DynamicBarchartPropsInterface): echarts.EChartsOption {
  var dataMap = {
    dataGDP: {},
